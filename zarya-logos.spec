...
* Wed Feb 16 2011 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl6.1
- Calling it done

* Wed Jan 26 2011 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl-0.7.rolling
- Better header_image.png for Plymouth, provided by Chris Pemberton

* Fri Jan 07 2011 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl-0.6.rolling
- Changed the gdm and kdm themes.  The kdm changed much more than the gdm

* Wed Jan 05 2011 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl-0.3.rolling
- Changed the background

* Tue Jan 04 2011 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl-0.2.rolling
- Fixed Plymouth Rings and Charge images
- Removed the rnotes section from anaconda since it wasn't working

* Tue Nov 23 2010 Troy Dawson <dawson@fnal.gov> 60.0.14-1.sl-0.1.rolling
- Updated all trademarked images, replacing them with S.L. logos
- Added rnotes to the anaconda section
- Put Glow back into the plymouth section.
